...
%}
clear; %close all; clc; 
folder_wsl = "\\wsl.localhost\Ubuntu-20.04\home\marco\unsteady_3_profili_deform1\";
...
fig_observer_loc = figure('Position',[100,100,600,500]);
hold on; grid minor;
scatter(newPoints{1}(:,1),newPoints{1}(:,2),'DisplayName','New observer locations 5')
scatter(newPoints{2}(:,1),newPoints{2}(:,2),'DisplayName','New observer locations 10')
